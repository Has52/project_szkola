<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        // insert into goals values (null, gameid, teamid, playerid, time, null, null);

        $con->query("INSERT INTO goals VALUES (NULL, $match_id, $team_id, $player_id, NULL, $points, NULL)");
